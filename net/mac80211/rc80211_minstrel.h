...
struct minstrel_sta_info {
	...
	int n_rates;
	int trasm_index;				// AGGIUNTO
	int trasm_number;				// AGGIUNTO
	bool isSampling;				// AGGIUNTO
	struct minstrel_rate *r;
	struct minstrel_tx t[TX_RECORDED];		// AGGIUNTO
	bool prev_sample;
...
struct minstrel_priv {
	...
	//unsigned int segment_size;			// RIMOSSO
	//unsigned int update_interval;			// RIMOSSO
	//unsigned int lookaround_rate; 		// RIMOSSO
	//unsigned int lookaround_rate_mrr;		// RIMOSSO
