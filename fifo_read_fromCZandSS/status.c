...
/* ZUUUUUUUUUUUUUUU **********************/
extern data_sched_t data_sched_buf[SCHED_BUF_DIM];
extern int sched_in;
/* ZUUUUUUUUUUUUUUU **********************/
...
/* ZUUUUUUUUUUUUUUU **********************/
		{
			...
			data_sched_buf[sched_in].success=acked;      //Copy of the transmission status
			memcpy(&(data_sched_buf[sched_in].id),p_data,8);  //Copy of our ID

			sched_in = (sched_in+1)%SCHED_BUF_DIM;
